...
links=pd.read_csv('./Data(net)/hosp_sample.csv').LINKS     #use the address of the csv file if not present in same directory.
hosp_name=pd.read_csv('./Data(net)/hosp_sample.csv')['HOSPITAL NAME']
